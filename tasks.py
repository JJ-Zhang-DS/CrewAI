...
class MeetingPrepTask():
    ...
    def research_task(self, agent, meeting_participants, meeting_context):
        """Research the participants of the meeting"""
        return Task(
            description = dedent(f"""
				...
				business activities. 
            Participants are: {meeting_participants}
            meeting context is: {meeting_context}
                """),
            expected_output = dedent(f"""
                A list of individuals and companies with their information.
                highlight the most relevant information for the meeting.
            """),
            agent = agent,
